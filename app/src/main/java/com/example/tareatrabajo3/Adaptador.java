...
public class Adaptador extends RecyclerView.Adapter<Adaptador.VistaTareas> {
    ...
    public Adaptador(List<Tarea> listaTareas) {
        this.listaTareas = listaTareas;
    }

    @NonNull
    @Override
    public VistaTareas onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View vista = LayoutInflater.from(parent.getContext()).inflate(R.layout.item, parent, false);
        return new VistaTareas(vista);
    }

    @Override
    public void onBindViewHolder(@NonNull VistaTareas holder, int position) {
